...
For a complete list of query settings please reference the [arangodb.com documentation](https://docs.arangodb.com/latest/AQL/Invocation/WithArangosh.html#setting-options).
